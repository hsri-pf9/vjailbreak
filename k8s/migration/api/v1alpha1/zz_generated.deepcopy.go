...
func (in *VMwareMachineSpec) DeepCopyInto(out *VMwareMachineSpec) {
	*out = *in
	...
	if in.ExistingPortIDs != nil {
		in, out := &in.ExistingPortIDs, &out.ExistingPortIDs
		*out = make([]string, len(*in))
		copy(*out, *in)
	}
	if in.CopiedVolumeIDs != nil {
		in, out := &in.CopiedVolumeIDs, &out.CopiedVolumeIDs
		*out = make([]string, len(*in))
		copy(*out, *in)
	}
	if in.ConvertedVolumeIDs != nil {
		in, out := &in.ConvertedVolumeIDs, &out.ConvertedVolumeIDs
		*out = make([]string, len(*in))
		copy(*out, *in)
	}
}
